...
export const PLATFORM_UI_FIELDS: PlatUiField[] = reg([
  ...
  ...(
    [
      ...
      ["mapEmbedUrl", "رابط تضمين الخريطة (Embed URL)", "Map embed URL", "ضع رابط src فقط من Google Maps Embed. لا تضع iframe كامل.", "Use Google Maps embed src only, not full iframe markup."],
