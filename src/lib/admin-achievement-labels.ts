  ...
  resolveAchievementResultDisplay(
    {
      ...
      customAchievementName: String(raw.customAchievementName || ""),
      title: String(raw.title || raw.nameAr || raw.nameEn || ""),
      resultType: String(raw.resultType || ""),
      resultValue: String(raw.resultValue || ""),
      medalType: String(raw.medalType || ""),
      rank: String(raw.rank || ""),
      nominationText: String(raw.nominationText || ""),
      specialAwardText: String(raw.specialAwardText || ""),
