...
const PARTNERSHIP_SUPERVISOR_ROLE = "partnershipSupervisor";
...
export const getPostLoginDestination = (input: {
  ...
  if (r === PARTNERSHIP_SUPERVISOR_ROLE) return "/admin/partnerships";
  if (r === "trainingInstitution") return "/institution/training";
