...
const minimalExecutivePayload = (): ExecutiveDecisionIntelligencePayload => ({
  ...
  partnershipIntelligence: {
    ...
    finalEvaluationAnalytics: {
      trainingSatisfactionAverage: 0,
      institutionEvaluationAverage: 0,
      trainingHoursTotal: 0,
      trainingCompletionQualityIndex: 0,
      studentRecommendationRate: 0,
      employmentRecommendationRate: 0,
      institutionRecommendationRate: 0,
      safetyComplianceAverage: 0,
      technicalSkillsAverage: 0,
      studentEvaluationCount: 0,
      institutionEvaluationCount: 0,
      approvedCount: 0,
    ...
    trainingOutcomeAnalytics: {
      ...
      recommendedForEmploymentRate: 0,
      outstandingTraineeCount: 0,
      institutionRecommendationRate: 0,
      outcomeDistribution: {
        excellent: 0,
        very_good: 0,
